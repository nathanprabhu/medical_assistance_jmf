            ...
            try {
				...
				// if(w>80){
				    System.out.println("Heard bit is ..."+str);
						stmt.executeUpdate("update patientinfo set heartbit='"+str.trim().substring(2,5)+"' ");
						//FileOutputStream fout=new FileOutputStream("help.txt");
						//fout.write((str.trim().substring(2,5)).getBytes());
						//fout.close();
				  /*   con = getConncetion();
				     stmt = con.createStatement();
