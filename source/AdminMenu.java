...
class AdminMenu extends JFrame 
 {
	...
	public AdminMenu(){
 	...
 	private void initializeComponent(){
		...
		bgr.setText("Admin Menu");
		bgr.setFont(new Font("monotype corsiva",2,30));			
		contentPane = (JPanel)this.getContentPane();

		
		// Cloud Computing
		jButton0.setText("Registor new Doctors");
		...
		jButton1.setText("Doctors Availability");
...
// Hospital
    	...
    	jButton4.setText("Display Medicine Stocks");
		...
		jButton5.setText("Check Expire Date");
